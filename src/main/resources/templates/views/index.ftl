                            ...
                            <ul aria-labelledby="notifications" class="dropdown-menu">
                                <li><a rel="nofollow" href="#" class="dropdown-item d-flex">
                                        <div class="msg-profile"><img src="/static/img/avatar-1.jpg" alt="..."
                                                                      class="/static/img-fluid rounded-circle"></div>
                                        <div class="msg-body">
                        ...
                        <li class="nav-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#"
                            ...
                            <ul aria-labelledby="languages" class="dropdown-menu">
                                <li><a rel="nofollow" href="#" class="dropdown-item"> <img
                                                src="/static/img/flags/16/DE.png" alt="English" class="mr-2">German</a>
                                </li>
                                <li><a rel="nofollow" href="#" class="dropdown-item"> <img
                                                src="/static/img/flags/16/FR.png" alt="English" class="mr-2">French </a>
                                </li>
                            </ul>
                        </li>
                        <!-- Logout    -->
                        <li class="nav-item"><a href="login" class="nav-link logout"> <span class="d-none d-sm-inline">Logout</span><i
                ...
                <div class="container-fluid">
                        ...
                        <div class="row bg-white has-shadow">
                            <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                                <div class="project-title d-flex align-items-center">
                                    <div class="image has-shadow"><img src="/static/img/project-1.jpg" alt="..."
                                                                       class="/static/img-fluid"></div>
                                    <div class="text">
                    ...
                    <div class="project">
                        <div class="row bg-white has-shadow">
                            <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                                <div class="project-title d-flex align-items-center">
                                    <div class="image has-shadow"><img src="/static/img/project-2.jpg" alt="..."
                                                                       class="/static/img-fluid"></div>
                                    <div class="text">
                                        <h3 class="h4">Project Title</h3>
                                        <small>Lorem Ipsum Dolor</small>
                    ...
                    <div class="project">
                        <div class="row bg-white has-shadow">
                            <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                                <div class="project-title d-flex align-items-center">
                                    <div class="image has-shadow"><img src="/static/img/project-3.jpg" alt="..."
                                                                       class="/static/img-fluid"></div>
                                    <div class="text">
                                        <h3 class="h4">Project Title</h3>
                                        <small>Lorem Ipsum Dolor</small>
                    ...
                    <div class="project">
                        <div class="row bg-white has-shadow">
                            <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                                <div class="project-title d-flex align-items-center">
                                    <div class="image has-shadow"><img src="/static/img/project-4.jpg" alt="..."
                                                                       class="/static/img-fluid"></div>
                                    <div class="text">
                                        <h3 class="h4">Project Title</h3>
                                        <small>Lorem Ipsum Dolor</small>
                        ...
                        <div class="col-lg-4">
                            <div class="client card">
                                ...
                                <div class="card-body text-center">
                                    <div class="client-avatar"><img src="/static/img/avatar-2.jpg" alt="..."
                                                                    class="/static/img-fluid rounded-circle">
                        ...
                        <div class="col-lg-6">
                            <div class="articles card">
                                ...
                                <div class="card-body no-padding">
                                    <div class="item d-flex align-items-center">
                                        <div class="image"><img src="/static/img/avatar-1.jpg" alt="..."
                                                                class="/static/img-fluid rounded-circle"></div>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="image"><img src="/static/img/avatar-2.jpg" alt="..."
                                                                class="/static/img-fluid rounded-circle"></div>
                                        <div class="text"><a href="#">
                                                <h3 class="h5">Lorem Ipsum Dolor</h3></a>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="image"><img src="/static/img/avatar-3.jpg" alt="..."
                                                                class="/static/img-fluid rounded-circle"></div>
                                        <div class="text"><a href="#">
                                                <h3 class="h5">Lorem Ipsum Dolor</h3></a>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="image"><img src="/static/img/avatar-4.jpg" alt="..."
                                                                class="/static/img-fluid rounded-circle"></div>
                                        <div class="text"><a href="#">
                                                <h3 class="h5">Lorem Ipsum Dolor</h3></a>
                                    ...
                                    <div class="item d-flex align-items-center">
                                        <div class="image"><img src="/static/img/avatar-5.jpg" alt="..."
                                                                class="/static/img-fluid rounded-circle"></div>
                                        <div class="text"><a href="#">
                                                <h3 class="h5">Lorem Ipsum Dolor</h3></a>
                                ...
                                <div class="card-body no-padding">
                                    ...
                                    <div class="item">
                                        <div class="feed d-flex justify-content-between">
                                            <div class="feed-body d-flex justify-content-between"><a href="#"
                                                            ...
                                                            src="/static/img/avatar-5.jpg" alt="person"
                                                            class="/static/img-fluid rounded-circle"></a>
                                                <div class="content">
                                    ...
                                    <div class="item">
                                        <div class="feed d-flex justify-content-between">
                                            <div class="feed-body d-flex justify-content-between"><a href="#"
                                                                                                     class="feed-profile"><img
                                                            src="/static/img/avatar-2.jpg" alt="person"
                                                            class="/static/img-fluid rounded-circle"></a>
                                                <div class="content">
                                    ...
                                    <div class="item clearfix">
                                        <div class="feed d-flex justify-content-between">
                                            <div class="feed-body d-flex justify-content-between"><a href="#"
                                                                                                     class="feed-profile"><img
                                                            src="/static/img/avatar-3.jpg" alt="person"
                                                            class="/static/img-fluid rounded-circle"></a>
                                                <div class="content">
