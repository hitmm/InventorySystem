package com.devil.inventory.web.init;

import com.devil.inventory.model.service.message.MessageType;
import com.devil.inventory.model.service.message.PushMessage;
import com.devil.inventory.service.heartbeat.IHeartBeatService;
import com.devil.inventory.service.serverpush.IPushService;
...
public class ApplicationInit implements ApplicationContextInitializer {
    ...
    public void initialize(ConfigurableApplicationContext configurableApplicationContext) {
        pushService = configurableApplicationContext.getBean("com.devil.inventory.service.serverpush.PushService", IPushService.class);
        hearBeatService = configurableApplicationContext.getBean("com.devil.inventory.service.serverpush.IHeartBeatService", IHeartBeatService.class);
        try {
