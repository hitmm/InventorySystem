                                    ...
                                    <form class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <small class="form-text">Example help text that remains unchanged.
                                                </small>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control">
                                                <small class="help-block-none">A block of help text that breaks onto a
                                        ...
                                        <div class="line"></div>
                                        <div class="form-group row">
                                            <label class="col-sm-3 form-control-label">Checkboxes and radios <br>
                                                <small class="text-primary">Normal Bootstrap elements</small>
                                            </label>
                                            <div class="col-sm-9">
                                                <div>
                                        ...
                                        <div class="line"></div>
                                        <div class="form-group row">
                                            <label class="col-sm-3 form-control-label">Checkboxes &amp; radios <br>
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        ...
                                                        <div class="dropdown-menu"><a href="#" class="dropdown-item">Action</a><a
                                                                    ...
                                                                    href="#" class="dropdown-item">Something else
                                                                here</a>
