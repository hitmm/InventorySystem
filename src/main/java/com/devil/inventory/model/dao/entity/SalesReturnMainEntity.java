 ...
 */
@Entity
@Table(name = "tb_sales_return_main", schema = "inventory")
public class SalesReturnMainEntity {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        SalesReturnMainEntity that = (SalesReturnMainEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, varietiesNum, totalMoney, accConclusion, returnTime, tradesWay, createTime, updateTime);
    }
