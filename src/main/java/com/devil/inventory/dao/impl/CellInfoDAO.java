...
import com.devil.inventory.dao.service.ICellInfoDAO;
...
public class CellInfoDAO extends BaseDAO implements ICellInfoDAO {
    ...
    private final static String QUERY_COL_ROW_HQL = "from CellInfoEntity where colId = ?0 and colId = ?1";
    private final static String QUERY_ROW_HQL = "from CellInfoEntity where colId = ?0";
