 ...
 */
@Entity
@Table(name = "tb_warehouse_store_main", schema = "inventory")
public class WarehouseStoreMainEntity {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        WarehouseStoreMainEntity that = (WarehouseStoreMainEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, varietiesNum, totalMoney, accConclusion, customerId, returnTime, operatorId, handlerId, tradesWay, createTime, updateTime);
    }
}
