          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                ...
                <!-- Navbar Brand --><a href = "#"  onclick="index(${userInfo.userName},${userInfo.password})" class="navbar-brand d-none d-sm-inline-block">
                ...
                <li class="nav-item dropdown"> <a id="messages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><i class="fa fa-envelope-o"></i><span class="badge bg-orange badge-corner">10</span></a>
                  <ul aria-labelledby="notifications" class="dropdown-menu">
                    <li><a rel="nofollow" href="#" class="dropdown-item d-flex"> 
                        <div class="msg-profile"> <img src="/static/img/avatar-1.jpg" alt="..." class="/static/img-fluid rounded-circle"></div>
                        <div class="msg-body">
                          <h3 class="h5">Jason Doe</h3><span>Sent You Message</span>
                        </div></a></li>
                    <li><a rel="nofollow" href="#" class="dropdown-item d-flex"> 
                        <div class="msg-profile"> <img src="/static/img/avatar-2.jpg" alt="..." class="/static/img-fluid rounded-circle"></div>
                        <div class="msg-body">
                          <h3 class="h5">Frank Williams</h3><span>Sent You Message</span>
                        </div></a></li>
                    <li><a rel="nofollow" href="#" class="dropdown-item d-flex"> 
                        <div class="msg-profile"> <img src="/static/img/avatar-3.jpg" alt="..." class="/static/img-fluid rounded-circle"></div>
                        <div class="msg-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      <div class="image has-shadow"><img src="/static/img/project-1.jpg" alt="..." class="/static/img-fluid"></div>
                      <div class="text">
              ...
              <div class="project">
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      <div class="image has-shadow"><img src="/static/img/project-2.jpg" alt="..." class="/static/img-fluid"></div>
                      <div class="text">
                        <h3 class="h4">Project Title</h3><small>Lorem Ipsum Dolor</small>
                      </div>
                    </div>
              ...
              <div class="project">
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      <div class="image has-shadow"><img src="/static/img/project-3.jpg" alt="..." class="/static/img-fluid"></div>
                      <div class="text">
                        <h3 class="h4">Project Title</h3><small>Lorem Ipsum Dolor</small>
                      </div>
                    </div>
              ...
              <div class="project">
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      <div class="image has-shadow"><img src="/static/img/project-4.jpg" alt="..." class="/static/img-fluid"></div>
                      <div class="text">
                        <h3 class="h4">Project Title</h3><small>Lorem Ipsum Dolor</small>
                      </div>
                    </div>
                ...
                <div class="col-lg-4">
                  <div class="client card">
                    ...
                    <div class="card-body text-center">
                      <div class="client-avatar"><img src="/static/img/avatar-2.jpg" alt="..." class="/static/img-fluid rounded-circle">
                ...
                <div class="col-lg-6">
                  <div class="articles card">
                    ...
                    <div class="card-body no-padding">
                      <div class="item d-flex align-items-center">
                        <div class="image"><img src="/static/img/avatar-1.jpg" alt="..." class="/static/img-fluid rounded-circle"></div>
                        <div class="text"><a href="#">
                            <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Aria Smith.   </small></div>
                      </div>
                      <div class="item d-flex align-items-center">
                        <div class="image"><img src="/static/img/avatar-2.jpg" alt="..." class="/static/img-fluid rounded-circle"></div>
                        <div class="text"><a href="#">
                            <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Frank Williams.   </small></div>
                      </div>
                      <div class="item d-flex align-items-center">
                        <div class="image"><img src="/static/img/avatar-3.jpg" alt="..." class="/static/img-fluid rounded-circle"></div>
                        <div class="text"><a href="#">
                            <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Ashley Wood.   </small></div>
                      </div>
                      <div class="item d-flex align-items-center">
                        <div class="image"><img src="/static/img/avatar-4.jpg" alt="..." class="/static/img-fluid rounded-circle"></div>
                        <div class="text"><a href="#">
                            <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Jason Doe.   </small></div>
                      </div>
                      <div class="item d-flex align-items-center">
                        <div class="image"><img src="/static/img/avatar-5.jpg" alt="..." class="/static/img-fluid rounded-circle"></div>
                        <div class="text"><a href="#">
                    ...
                    <div class="card-body no-padding">
                      ...
                      <div class="item">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="/static/img/avatar-5.jpg" alt="person" class="/static/img-fluid rounded-circle"></a>
                            <div class="content">
                      ...
                      <div class="item"> 
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="/static/img/avatar-2.jpg" alt="person" class="/static/img-fluid rounded-circle"></a>
                            <div class="content">
                      ...
                      <div class="item clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="/static/img/avatar-3.jpg" alt="person" class="/static/img-fluid rounded-circle"></a>
                            <div class="content">
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6 text-right">
                  <p>Contact with me : 296160621@qq.com</p>
